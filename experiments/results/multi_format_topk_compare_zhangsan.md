# Multi-format Top-k Compare: 张三在哪个部门？
...
- top_k: 3 / 5 / 8
- purpose: compare how increasing top_k changes retrieved chunks and final prompt
...
2. score=0.5452, source=data/raw/test_web.html, page=None, mode=web
   preview=下面这张表格列出了各部门的人员信息，包括姓名、部门和入职日期三个字段。
3. score=0.5442, source=data/raw/test_web.html, page=None, mode=web, table=1, table_chunk=2
   preview=姓名 部门 入职日期 李四 市场部 2023-03-20 王五 财务部 2022-11-08
...
3. score=0.5442, source=data/raw/test_web.html, page=None, mode=web, table=1, table_chunk=2
   preview=姓名 部门 入职日期 李四 市场部 2023-03-20 王五 财务部 2022-11-08
4. score=0.5013, source=data/raw/test_web.html, page=None, mode=web
   preview=如需更新人员变动，请联系人事部门。
5. score=0.4929, source=data/raw/test_web.html, page=None, mode=web
...
1. score=0.7560, source=data/raw/test_table.pdf, page=1, mode=table, table=1, table_chunk=1
   preview=姓名 部门 入职日期 张三 技术部 2023-01-15
2. score=0.5443, source=data/raw/test_table.pdf, page=1, mode=table, table=1, table_chunk=2
   preview=姓名 部门 入职日期 李四 市场部 2023-03-20 王五 财务部 2022-11-08
3. score=0.3999, source=data/raw/test_table.pdf, page=1, mode=table
   preview=公司部门人员名单测试文档 这是一份测试用文档,用来验证 PDF 解析模块的表格提取功能。下面这张表格列出了各部门的人员信 息,包括姓名、部门和入职日期三个字段。表格之后还有一段补充说明文字,用来测试 mode='table' 模式下,表格之
...
5. score=0.4816, source=data/raw/test_word.docx, page=None, mode=word
   preview=公司部门人员名单测试 Word 文档
6. score=0.4220, source=data/raw/test_word.docx, page=None, mode=word
   preview=补充说明：以上数据为测试用途，不代表真实人员信息。
7. score=0.3344, source=data/raw/test_word.docx, page=None, mode=word
...
5. score=0.4929, source=data/raw/test_web.html, page=None, mode=web
   preview=公司部门人员名单测试网页
6. score=0.4220, source=data/raw/test_web.html, page=None, mode=web
   preview=补充说明：以上数据为测试用途，不代表真实人员信息。
7. score=0.3283, source=data/raw/test_web.html, page=None, mode=web
